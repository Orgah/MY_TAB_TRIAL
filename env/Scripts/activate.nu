...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\aa My Folder\Web Dev't\Python\my_TAB_trial\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\aa My Folder\Web Dev't\Python\my_TAB_trial\env\Scripts\deactivate.nu'
